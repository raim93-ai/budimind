...
| SQLite schema and seed rows                  | Reject                    | Wrong production boundary; sequential IDs and prototype data risk disclosure                                    | Separate PostgreSQL migrations and synthetic fixtures                             |
