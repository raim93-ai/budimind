-- S02-T01: private, append-only platform primitives for the clinical plane.
...
create table if not exists private.app_actor (
  ...
  role text not null check (role in ('clinic_admin','clinical_practitioner','receptionist','privacy_reviewer','platform_operations')),
