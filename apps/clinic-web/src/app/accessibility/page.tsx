...
export const metadata: Metadata = {
  title: 'Accessibility | BudiMind Clinic',
  description:
    'Accessibility statement for BudiMind Clinic - our commitment to digital accessibility.',
  alternates: { canonical: 'https://clinic.budimind.com/accessibility' },
};
      ...
      <div className="container">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-2xl mx-auto">
          ...
          <p className="text-secondary mb-6">
            BudiMind Clinic is committed to ensuring digital accessibility for people with
          ...
          <div className="space-y-4 text-left">
            ...
            <div>
              ...
              <ul className="list-disc pl-5">
                ...
                <li>
                  Sufficient color contrast ratios (minimum 4.5:1) — see{' '}
                  <a
            ...
            <div>
              ...
              <p className="text-secondary mb-3">
                If you experience difficulty accessing any part of BudiMind Clinic, please contact
                us:
              </p>
              <div className="mt-4">
