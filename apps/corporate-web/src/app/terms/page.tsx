      ...
      <div className="container">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-2xl mx-auto">
          ...
          <p className="text-secondary mb-6">
            These Terms of Service govern your use of the BudiMind Corporate platform and associated
            services.
          </p>
          <div className="space-y-4 text-left">
            <div>
              ...
              <p className="text-secondary mb-3">
                ...
                Corporate website or any other media form, channel, mobile application, or online
                service.
              </p>
            </div>
            <div>
              ...
              <p className="text-secondary mb-3">
                When you create an account with BudiMind Corporate, you agree to provide accurate,
            ...
            <div>
              ...
              <p className="text-secondary mb-3">
                You agree not to use the BudiMind Corporate platform for any illegal or unauthorized
                purpose. You must not, in the use of the Service, violate any local, state, national
                or international law.
              </p>
            </div>
            <div>
              <h4 className="font-medium mb-2">4. No Diagnostic / Disclaimer</h4>
              <p className="text-secondary mb-3">
                The platform provides evidence-based screening instruments for organisational
                wellbeing insights. These tools are not clinical diagnostic instruments and should
                not be used as a sole basis for employment decisions or medical advice. Always
                consult with a qualified healthcare provider for individual concerns.
              </p>
            </div>
            <div>
              <h4 className="font-medium mb-2">5. Termination</h4>
              <p className="text-secondary mb-3">
                BudiMind Corporate may terminate or suspend your account immediately, without prior
