      ...
      <div className="container">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-2xl mx-auto">
          ...
          <p className="text-secondary mb-6">
            At BudiMind Corporate, we are committed to protecting your privacy and ensuring your
            organisational and workforce data is handled with the utmost care.
          </p>
          <div className="space-y-4 text-left">
            <div>
              <h4 className="font-medium mb-2">Information We Collect</h4>
              <ul className="list-disc pl-5">
                <li>Organisation and admin contact information</li>
                <li>Aggregate workforce well-being data</li>
            ...
            <div>
              ...
              <ul className="list-disc pl-5">
                <li>To provide and improve our workforce wellbeing platform</li>
                <li>To generate privacy-released aggregate insights for your organisation</li>
            ...
            <div>
              ...
              <ul className="list-disc pl-5">
                <li>Access to your organisation's data</li>
